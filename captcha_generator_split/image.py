...
class ImageCaptcha(_Captcha):
    ...
    """
    def __init__(self, width=160, height=60, fonts=None, font_sizes=None, output_width=56, output_height=28):
        self._width = width
        self._height = height
        self._fonts = fonts or DEFAULT_FONTS
    ...
    def create_captcha_image(self, chars, color, background):
        ...
        second_text_width = int(images[middle_c_index].size[0] / 2) + sum([im.size[0] for im in images[middle_c_index+1:]])
        if 2 * second_text_width > width:
            width = 2 * second_text_width
