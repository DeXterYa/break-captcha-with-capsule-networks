...
def get_args():
    ...
    # Data directory
    parser.add_argument('--data_path', type=str, default="data/CAPTCHA_4digits",
    ...
    parser.add_argument('--method', nargs='?', type=str, default='1')
    parser.add_argument('--num_train_val', type=int, default=60000)
    parser.add_argument('--coord', nargs='?', type=str, default='False')
