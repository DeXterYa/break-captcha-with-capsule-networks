...
DATASET = "CAPTCHA_4digits_noise"
num_train = 60000
num_test = 10000
num_digit = 4
partition_size = 10000

img = ImageCaptcha(width = 162, height = 72)
...
for i in tqdm(range(num_train)):
    ...
    image = transform(img.generate(chars=sequence, data="train"))
...
for i in tqdm(range(num_test)):
    ...
    image = transform(img.generate(sequence, data="test"))
